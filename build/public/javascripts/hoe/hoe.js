...
$(document).ready(function () {
    HoeDatapp = {
        ...
        Handleactivestatemenu: function Handleactivestatemenu() {
        ...
        Handlesidebarside: function Handlesidebarside() {
        ...
        Handlenavigationtype: function Handlenavigationtype() {
        ...
        HandleProfileToggle: function HandleProfileToggle() {
        ...
        Handlethemecolor: function Handlethemecolor() {
        ...
        Handlecontentheight: function Handlecontentheight() {
        ...
        Handlesidebarposition: function Handlesidebarposition() {
        ...
        Handlesidebareffect: function Handlesidebareffect() {
        ...
        Handlethemeoption: function Handlethemeoption() {
            $('.selector-toggle > a').on("click", function () {
                $('#styleSelector').toggleClass('open');
            });
        },
        Handlelpanelmenu: function Handlelpanelmenu() {
        ...
        Handlelpanel: function Handlelpanel() {
